...
?>				 
    ...
    <div id="content" style="height:88%">
          ...
          <ul>
               <li>
                    <a href="#tabs-1" id="tab1">
                        <img class='logoImage2' border="0" width="22%" src="../images/material_A.png">
                        <font size="4">螢幕與面板</font>
   
                    </a>
            </li>
                <li>
                    <a href="#tabs-2" id="tab2">
                        <img class='logoImage2' border="0" width="22%" src="../images/material_B.png">
                        <font size="4">主機板與核心電路</font>
                    </a>
                </li>
                 <li>
                    <a href="#tabs-3" id="tab3">
                        <img class='logoImage2' border="0" width="22%" src="../images/material_C.png">
                        <font size="4">鍵盤基座</font>
                    </a>
        ...
        <div id="tabs-1">
           ...
           <!---->
           <li style="float:right; width:35%; height:38%; margin-right:1%; background-image:url(../images/note08.png); background-repeat:no-repeat;">
           <p style="height:7%"><p></li>
		  <table class="table1" width="60%">
            <thead>
                <tr>
                    <td width="10%"></td>
                    <th scope="col" style="width:12%">供貨能力</th>
                    <th scope="col" style="width:12%">庫存量</th>
                    <th scope="col" style="width:12%">本月訂購量</th>
                    <th scope="col" style="width:12%">單價</th>
					<th scope="col" style="width:12%">購買量</th>
                </tr>
            </thead>
            <tbody>
                 <tr>
                    <th scope="row">供應商A</th>
                    <td align="center"><span id="pA_power">0</span></td>
                    <td align="center"><span id="pA_inventory">0</span></td>
					<td align="center"><span id="pA_thismonth">0</span></td>
					<td align="center"><span id="pA_price">0</span></td>
					<td><input id="pnum_A" onBlur="total()" size="5px" style="text-align:right"></td>
                    
                </tr>
                <tr>
                    <th scope="row">供應商B</th>
                    <td align="center"><span id="pB_power">0</span></td>
                    <td align="center"><span id="pB_inventory">0</span></td>
					<td align="center"><span id="pB_thismonth">0</span></td>
					<td align="center"><span id="pB_price">0</span></td>
					<td><input id="pnum_B" onBlur="total()" size="5px" style="text-align:right"></td>
                </tr>
               <tr>
                    <th scope="row">供應商C</th>
                    <td align="center"><span id="pC_power">0</span></td>
                    <td align="center"><span id="pC_inventory">0</span></td>
					<td align="center"><span id="pC_thismonth">0</span></td>
					<td align="center"><span id="pC_price">0</span></td>
					<td><input id="pnum_C" onBlur="total()" size="5px" style="text-align:right"></td>
              </tr>
                ...
                <tr>
                    <td colspan="2"></td>
                    <th>總費用</th>
                    <td>$<span id="p_total">0</span></td><td align="center"> 
                    	<input type="image" src="../images/submit6.png" id="submit_p" style="width:100px"></td>
                  </tr>
                </tfoot>    
          </table> 
        </div> 
              <div id="tabs-2"><li style="float:right; width:35%; height:38%; margin-right:1%; background-image:url(../images/note08.png); background-repeat:no-repeat;">
           <p style="height:7%"><p></li>
            <p>
            <table class="table1" width="60%">
            <thead>
                <tr>
                    ...
                    <th scope="col" style="width:12%">本月訂購量</th>
                    <th scope="col" style="width:12%">單價</th>
					<th scope="col" style="width:12%">訂購量</th>
                </tr>
            </thead>
            <tbody>
               <tr>
                    <th scope="row">供應商A</th>
                    <td align="center"><span id="cA_power">0</span></td>
                    <td align="center"><span id="cA_inventory">0</span></td>
					<td align="center"><span id="cA_thismonth">0</span></td>
					<td align="center"><span id="cA_price">0</span></td>
					<td><input id="cnum_A" onBlur="total()" size="5px" style="text-align:right"></td>
              </tr>
                <tr>
                    <th scope="row">供應商B</th>
                    <td align="center"><span id="cB_power">0</span></td>
                    <td align="center"><span id="cB_inventory">0</span></td>
					<td align="center"><span id="cB_thismonth">0</span></td>
					<td align="center"><span id="cB_price">0</span></td>
					<td><input id="cnum_B" onBlur="total()" size="5px" style="text-align:right"></td>
                </tr>
               <tr>
                    <th scope="row">供應商C</th>
                    <td align="center"><span id="cC_power">0</span></td>
                    <td align="center"><span id="cC_inventory">0</span></td>
					<td align="center"><span id="cC_thismonth">0</span></td>
					<td align="center"><span id="cC_price">0</span></td>
					<td><input id="cnum_C" onBlur="total()" size="5px" style="text-align:right"></td>
              </tr>
                ...
                <tr>
                   <td colspan="2"></td>
                    <th>總費用</th>
                    <td>$<span id="c_total">0</span></td><td align="center"> <input type="image" src="../images/submit6.png" id="submit_c" style="width:100px"></td>
                  </tr>
                </tfoot>    
            </table>
            
        </div>
		<div id="tabs-3"><li style="float:right; width:35%; height:38%; margin-right:1%; background-image:url(../images/note08.png); background-repeat:no-repeat;">
           <p style="height:7%"><p></li>
            <p>
            <table class="table1" width="60%">
            <thead>
            ...
            <tbody>
                <tr>
                    <th scope="row">供應商A</th>
                    <td align="center"><span id="kA_power">0</span></td>
					<td align="center"><span id="kA_inventory">0</span></td>
                    <td align="center"><span id="kA_thismonth">0</span></td>
					<td align="center"><span id="kA_price">0</span></td>
					<td><input id="knum_A" onBlur="total()" size="5px" style="text-align:right"></td>
                </tr>
                <tr>
                    <th scope="row">供應商B</th>
                    <td align="center"><span id="kB_power">0</span></td>
                    <td align="center"><span id="kB_inventory">0</span></td>
					<td align="center"><span id="kB_thismonth">0</span></td>
					<td align="center"><span id="kB_price">0</span></td>
					<td><input id="knum_B" onBlur="total()" size="5px" style="text-align:right"></td>
                </tr>
                <tr>
                    <th scope="row">供應商C</th>
                    <td align="center"><span id="kC_power">0</span></td>
                    <td align="center"><span id="kC_inventory">0</span></td>
					<td align="center"><span id="kC_thismonth">0</span></td>
					<td align="center"><span id="kC_price">0</span></td>
					<td><input id="knum_C" onBlur="total()" size="5px" style="text-align:right"></td>
                </tr>
                ...
                <tr>
                   <td colspan="2"></td>
                    <th>總費用</th>
                    <td>$<span id="k_total">0</span></td><td align="center"> 
                    	<input type="image" src="../images/submit6.png" id="submit_k" style="width:100px"></td>
                  </tr>
                </tfoot>    
            </table>
